    ...
    public static class LocalDateTimeAssertionsSpecs
    {
        ...
        public class BeDateTime
        {
            ...
            public void When_a_local_date_time_is_not_equal_to_a_datetime_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(localDateTime)} to be equal to {LocalDateTime.FromDateTime(other)}, but found {localDateTime}.");
            }
            ...
            public void When_asserting_null_is_equal_to_not_null_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(localDateTime)} to be equal to {LocalDateTime.FromDateTime(other)}, but found <null>.");
            }
        ...
        public class BeDateTimeAndCalendar
        {
            ...
            public void When_a_local_date_time_is_not_equal_to_a_datetime_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(localDateTime)} to be equal to {LocalDateTime.FromDateTime(other, calendar)}, but found {localDateTime}.");
            }
            ...
            public void When_a_local_date_time_is_not_equal_to_a_datetime_because_of_a_different_calendar_system_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(localDateTime)} to be equal to {LocalDateTime.FromDateTime(other, otherCalendar)}, but found {localDateTime}.");
            }
            ...
            public void When_asserting_null_is_equal_to_not_null_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(localDateTime)} to be equal to {LocalDateTime.FromDateTime(other, calendar)}, but found <null>.");
            }
        ...
        public class HaveTimeOfDay
        {
            ...
            public void When_a_local_date_time_does_not_have_the_specified_time_of_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(localDateTime)} to have time of day {time}, but found {localDateTime.TimeOfDay}.");
            }
        ...
        public class HaveClockHourOfHalfDay
        {
            ...
            public void When_a_local_date_time_does_not_have_the_specified_clock_hour_of_half_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(localDateTime)} to have clock hour of the half-day of {time}, but found {localDateTime.ClockHourOfHalfDay}.");
            }
            ...
            public void When_asserting_a_null_local_date_time_has_the_specified_clock_hour_of_half_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(localDateTime)} to have clock hour of the half-day of {time}, but found <null>.");
            }
        }
        ...
        public class NotHaveClockHourOfHalfDay
        {
            ...
            public void When_a_local_date_time_has_the_specified_clock_hour_of_half_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(localDateTime)} to have clock hour of the half-day of {localDateTime.ClockHourOfHalfDay}.");
            }
            ...
            public void When_asserting_a_null_local_date_time_does_not_have_the_specified_clock_hour_of_half_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(localDateTime)} to have clock hour of the half-day of {time}, but found <null>.");
            }
        }
        ...
        public class HaveDayOfWeek
        {
            ...
            public void When_a_local_date_does_not_have_the_specified_day_of_week_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(localDateTime)} to have day of week {dayOfWeek.AsFormatted()}, but found {localDateTime.DayOfWeek.AsFormatted()}.");
            }
            ...
            public void When_asserting_a_null_local_date_has_the_specified_day_of_week_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(localDateTime)} to have day of week {dayOfWeek.AsFormatted()}, but found <null>.");
            }
        }
        ...
        public class NotHaveDayOfWeek
        {
            ...
            public void When_a_local_date_has_the_specified_day_of_week_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(localDateTime)} to have day of week {localDateTime.DayOfWeek.AsFormatted()}.");
            }
            ...
            public void When_asserting_a_null_local_date_does_not_have_the_specified_day_of_week_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(localDateTime)} to have day of week {dayOfWeek.AsFormatted()}, but found <null>.");
            }
        }
        ...
        public class HaveDayOfYear
        {
            ...
            public void When_a_local_date_time_does_not_have_the_specified_day_of_year_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(localDateTime)} to have day of year {dayOfYear}, but found {localDateTime.DayOfYear}.");
            }
        ...
        public class HaveHour
        {
            ...
            public void When_a_local_date_time_does_not_have_the_specified_hour_of_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(localDateTime)} to have hour of day {hourOfDay}, but found {localDateTime.Hour}.");
            }
        ...
        public class HaveMillisecond
        {
            ...
            public void When_a_local_date_time_does_not_have_the_specified_millisecond_of_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(localDateTime)} to have millisecond {millisecondOfDay}, but found {localDateTime.Millisecond}.");
            }
        ...
        public class NotHaveMillisecond
        {
            ...
            public void When_asserting_a_null_local_date_time_does_not_have_the_specified_millisecond_of_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(localDateTime)} to have millisecond {millisecondOfDay}, but found <null>.");
            }
        }
        ...
        public class HaveMinute
        {
            ...
            public void When_a_local_date_time_does_not_have_the_specified_minute_of_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(localDateTime)} to have minute {minuteOfDay}, but found {localDateTime.Minute}.");
            }
        ...
        public class HaveNanosecondsWithinDay
        {
            ...
            public void When_a_local_date_time_does_not_have_the_specified_nanoseconds_within_the_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(localDateTime)} to have {nanosecondOfDay.AsFormatted()} nanoseconds within the day, but found {localDateTime.NanosecondOfDay.AsFormatted()}.");
            }
            ...
            public void When_asserting_a_null_local_date_time_has_the_specified_nanoseconds_within_the_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(localDateTime)} to have {nanosecondOfDay.AsFormatted()} nanoseconds within the day, but found <null>.");
            }
        }
        ...
        public class NotHaveNanosecondsWithinDay
        {
            ...
            public void When_a_local_date_time_has_the_specified_nanoseconds_within_the_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(localDateTime)} to have {localDateTime.NanosecondOfDay.AsFormatted()} nanoseconds within the day.");
            }
            ...
            public void When_asserting_a_null_local_date_time_does_not_have_the_specified_nanoseconds_within_the_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(localDateTime)} to have {nanosecondOfDay.AsFormatted()} nanoseconds within the day, but found <null>.");
            }
        }
        ...
        public class HaveNanosecondsWithinSecond
        {
            ...
            public void When_a_local_date_time_does_not_have_the_specified_nanoseconds_within_the_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(localDateTime)} to have {nanosecondOfSecond} nanoseconds within the second, but found {localDateTime.NanosecondOfSecond}.");
            }
            ...
            public void When_asserting_a_null_local_date_time_has_the_specified_nanoseconds_within_the_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(localDateTime)} to have {nanosecondOfSecond} nanoseconds within the second, but found <null>.");
            }
        }
        ...
        public class NotHaveNanosecondsWithinSecond
        {
            ...
            public void When_a_local_date_time_has_the_specified_nanoseconds_within_the_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(localDateTime)} to have {localDateTime.NanosecondOfSecond} nanoseconds within the second.");
            }
            ...
            public void When_asserting_a_null_local_date_time_does_not_have_the_specified_nanoseconds_within_the_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(localDateTime)} to have {nanosecondOfSecond} nanoseconds within the second, but found <null>.");
            }
        }
        ...
        public class HaveTicksWithinDay
        {
            ...
            public void When_a_local_date_time_does_not_have_the_specified_ticks_within_the_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(localDateTime)} to have {tickOfDay.AsFormatted()} ticks within the day, but found {localDateTime.TickOfDay.AsFormatted()}.");
            }
            ...
            public void When_asserting_a_null_local_date_time_has_the_specified_ticks_within_the_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(localDateTime)} to have {tickOfDay.AsFormatted()} ticks within the day, but found <null>.");
            }
        }
        ...
        public class NotHaveTicksWithinDay
        {
            ...
            public void When_a_local_date_time_has_the_specified_ticks_within_the_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(localDateTime)} to have {localDateTime.TickOfDay.AsFormatted()} ticks within the day.");
            }
            ...
            public void When_asserting_a_null_local_date_time_does_not_have_the_specified_ticks_within_the_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(localDateTime)} to have {tickOfDay.AsFormatted()} ticks within the day, but found <null>.");
            }
        }
        ...
        public class HaveTicksWithinSecond
        {
            ...
            public void When_a_local_date_time_does_not_have_the_specified_tick_of_second_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(localDateTime)} to have {tickOfSecond} ticks within the second, but found {localDateTime.TickOfSecond}.");
            }
            ...
            public void When_asserting_a_null_local_date_time_has_the_specified_tick_of_second_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(localDateTime)} to have {tickOfSecond} ticks within the second, but found <null>.");
            }
        }
        ...
        public class NotHaveTicksWithinSecond
        {
            ...
            public void When_a_local_date_time_has_the_specified_tick_of_second_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(localDateTime)} to have {localDateTime.TickOfSecond} ticks within the second.");
            }
            ...
            public void When_asserting_a_null_local_date_time_does_not_have_the_specified_tick_of_second_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(localDateTime)} to have {tickOfSecond} ticks within the second, but found <null>.");
            }
        }
        ...
        public class HaveYearWithinEra
        {
            ...
            public void When_a_local_date_time_does_not_have_the_specified_as_the_year_within_the_era_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(localDateTime)} to have {yearOfEra} as the year within the era, but found {localDateTime.YearOfEra}.");
            }
            ...
            public void When_asserting_a_null_local_date_time_has_the_specified_as_the_year_within_the_era_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(localDateTime)} to have {yearOfEra} as the year within the era, but found <null>.");
            }
        }
        ...
        public class NotHaveYearWithinEra
        {
            ...
            public void When_a_local_date_time_has_the_specified_as_the_year_within_the_era_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(localDateTime)} to have {localDateTime.YearOfEra} as the year within the era.");
            }
            ...
            public void When_asserting_a_null_local_date_time_does_not_have_the_specified_as_the_year_within_the_era_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(localDateTime)} to have {yearOfEra} as the year within the era, but found <null>.");
            }
        }
        ...
        public class BeGreaterThan
        {
            ...
            public void When_asserting_a_local_date_time_is_greater_than_itself_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(localDateTime)} to be greater than {localDateTime}, but found {localDateTime}.");
            }
        }
        ...
        public class BeGreaterThanOrEqualTo
        {
            ...
            public void When_a_local_date_time_is_less_than_an_other_local_date_time_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(localDateTime)} to be greater than or equal to {other}, but found {localDateTime}.");
            }
        }
        ...
        public class BeLessThanOrEqualTo
        {
            ...
            public void When_a_local_date_time_is_greater_than_an_other_local_date_time_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(localDateTime)} to be less than or equal to {other}, but found {localDateTime}.");
            }
        }
    }
}
