...
using AwesomeAssertions.NodaTime.Specs.Extensions;
using NodaTime;
using NodaTime.Calendars;
using Xunit;
using Xunit.Sdk;

namespace AwesomeAssertions.NodaTime.Specs
{
    public static class OffsetDateTimeAssertionsSpecs
    {
        ...
        public class HaveLocalDateTime
        {
            ...
            public void When_a_offset_local_date_time_does_not_have_the_specified_local_date_time_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(offsetDateTime)} to have local date time {localDateTime}, but found {offsetDateTime.LocalDateTime}.");
            }
        ...
        public class NotHaveLocalDateTime
        {
            ...
            public void When_asserting_a_null_offset_local_date_time_does_not_have_the_specified_local_date_time_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(offsetDateTime)} to have local date time {localDateTime}, but found <null>.");
            }
        }
        ...
        public class HaveOffset
        {
            ...
            public void When_a_offset_date_time_does_not_have_the_specified_offset_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(offsetDateTime)} to have offset {offset}, but found {offsetDateTime.Offset}.");
            }
        ...
        public class HaveOffsetTimeSpan
        {
            ...
            public void When_a_offset_date_time_does_not_have_the_specified_offset_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(offsetDateTime)} to have offset {Offset.FromTimeSpan(offset)}, but found {offsetDateTime.Offset}.");
            }
            ...
            public void When_asserting_a_null_offset_date_time_has_the_specified_offset_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(offsetDateTime)} to have offset {Offset.FromTimeSpan(offset)}, but found <null>.");
            }
        }
        ...
        public class NotHaveOffsetTimeSpan
        {
            ...
            public void When_asserting_a_null_offset_date_time_does_not_have_the_specified_offset_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(offsetDateTime)} to have offset {Offset.FromTimeSpan(offset)}, but found <null>.");
            }
        }
        ...
        public class HaveTimeOfDay
        {
            ...
            public void When_a_offset_date_time_does_not_have_the_specified_time_of_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(offsetDateTime)} to have time of day {time}, but found {offsetDateTime.TimeOfDay}.");
            }
        ...
        public class HaveClockHourOfHalfDay
        {
            ...
            public void When_a_offset_date_time_does_not_have_the_specified_clock_hour_of_half_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(offsetDateTime)} to have clock hour of the half-day of {time}, but found {offsetDateTime.ClockHourOfHalfDay}.");
            }
            ...
            public void When_asserting_a_null_offset_date_time_has_the_specified_clock_hour_of_half_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(offsetDateTime)} to have clock hour of the half-day of {time}, but found <null>.");
            }
        }
        ...
        public class NotHaveClockHourOfHalfDay
        {
            ...
            public void When_a_offset_date_time_has_the_specified_clock_hour_of_half_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(offsetDateTime)} to have clock hour of the half-day of {offsetDateTime.ClockHourOfHalfDay}.");
            }
            ...
            public void When_asserting_a_null_offset_date_time_does_not_have_the_specified_clock_hour_of_half_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(offsetDateTime)} to have clock hour of the half-day of {time}, but found <null>.");
            }
        }
        ...
        public class HaveDayOfWeek
        {
            ...
            public void When_a_offset_date_does_not_have_the_specified_day_of_week_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(offsetDateTime)} to have day of week {dayOfWeek.AsFormatted()}, but found {offsetDateTime.DayOfWeek.AsFormatted()}.");
            }
            ...
            public void When_asserting_a_null_offset_date_has_the_specified_day_of_week_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(offsetDateTime)} to have day of week {dayOfWeek.AsFormatted()}, but found <null>.");
            }
        }
        ...
        public class NotHaveDayOfWeek
        {
            ...
            public void When_a_offset_date_has_the_specified_day_of_week_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(offsetDateTime)} to have day of week {offsetDateTime.DayOfWeek.AsFormatted()}.");
            }
            ...
            public void When_asserting_a_null_offset_date_does_not_have_the_specified_day_of_week_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(offsetDateTime)} to have day of week {dayOfWeek.AsFormatted()}, but found <null>.");
            }
        }
        ...
        public class HaveDayOfYear
        {
            ...
            public void When_a_offset_date_time_does_not_have_the_specified_day_of_year_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(offsetDateTime)} to have day of year {dayOfYear}, but found {offsetDateTime.DayOfYear}.");
            }
        ...
        public class HaveHour
        {
            ...
            public void When_a_offset_date_time_does_not_have_the_specified_hour_of_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(offsetDateTime)} to have hour of day {hourOfDay}, but found {offsetDateTime.Hour}.");
            }
        ...
        public class HaveEra
        {
            ...
            public void When_a_offset_date_time_does_not_have_the_specified_era_it_fails()
            {
                // Arrange
                OffsetDateTime ad =
                    new OffsetDate(new(Era.Common, 1966, 9, 8, CalendarSystem.Iso), Offset.Zero).At(LocalTime.Midnight);
                OffsetDateTime bc =
                    new OffsetDate(new(Era.BeforeCommon, 384, 4, 16, CalendarSystem.Iso), Offset.Zero).At(LocalTime.Midnight);
        ...
        public class HaveMillisecond
        {
            ...
            public void When_a_offset_date_time_does_not_have_the_specified_millisecond_of_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(offsetDateTime)} to have millisecond {millisecondOfDay}, but found {offsetDateTime.Millisecond}.");
            }
        ...
        public class NotHaveMillisecond
        {
            ...
            public void When_asserting_a_null_offset_date_time_does_not_have_the_specified_millisecond_of_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(offsetDateTime)} to have millisecond {millisecondOfDay}, but found <null>.");
            }
        }
        ...
        public class HaveMinute
        {
            ...
            public void When_a_offset_date_time_does_not_have_the_specified_minute_of_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(offsetDateTime)} to have minute {minuteOfDay}, but found {offsetDateTime.Minute}.");
            }
        ...
        public class HaveNanosecondsWithinDay
        {
            ...
            public void When_a_offset_date_time_does_not_have_the_specified_nanoseconds_within_the_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(offsetDateTime)} to have {nanosecondOfDay.AsFormatted()} nanoseconds within the day, but found {offsetDateTime.NanosecondOfDay.AsFormatted()}.");
            }
            ...
            public void When_asserting_a_null_offset_date_time_has_the_specified_nanoseconds_within_the_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(offsetDateTime)} to have {nanosecondOfDay.AsFormatted()} nanoseconds within the day, but found <null>.");
            }
        }
        ...
        public class NotHaveNanosecondsWithinDay
        {
            ...
            public void When_a_offset_date_time_has_the_specified_nanoseconds_within_the_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(offsetDateTime)} to have {offsetDateTime.NanosecondOfDay.AsFormatted()} nanoseconds within the day.");
            }
            ...
            public void When_asserting_a_null_offset_date_time_does_not_have_the_specified_nanoseconds_within_the_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(offsetDateTime)} to have {nanosecondOfDay.AsFormatted()} nanoseconds within the day, but found <null>.");
            }
        }
        ...
        public class HaveNanosecondsWithinSecond
        {
            ...
            public void When_a_offset_date_time_does_not_have_the_specified_nanoseconds_within_the_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(offsetDateTime)} to have {nanosecondOfSecond} nanoseconds within the second, but found {offsetDateTime.NanosecondOfSecond}.");
            }
            ...
            public void When_asserting_a_null_offset_date_time_has_the_specified_nanoseconds_within_the_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(offsetDateTime)} to have {nanosecondOfSecond} nanoseconds within the second, but found <null>.");
            }
        }
        ...
        public class NotHaveNanosecondsWithinSecond
        {
            ...
            public void When_a_offset_date_time_has_the_specified_nanoseconds_within_the_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(offsetDateTime)} to have {offsetDateTime.NanosecondOfSecond} nanoseconds within the second.");
            }
            ...
            public void When_asserting_a_null_offset_date_time_does_not_have_the_specified_nanoseconds_within_the_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(offsetDateTime)} to have {nanosecondOfSecond} nanoseconds within the second, but found <null>.");
            }
        }
        ...
        public class HaveSecond
        {
            ...
            public void When_a_offset_date_time_does_not_have_the_specified_second_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(offsetDateTime)} to have second {second}, but found {offsetDateTime.Second}.");
            }
        ...
        public class HaveTicksWithinDay
        {
            ...
            public void When_a_offset_date_time_does_not_have_the_specified_ticks_within_the_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(offsetDateTime)} to have {tickOfDay.AsFormatted()} ticks within the day, but found {offsetDateTime.TickOfDay.AsFormatted()}.");
            }
            ...
            public void When_asserting_a_null_offset_date_time_has_the_specified_ticks_within_the_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(offsetDateTime)} to have {tickOfDay.AsFormatted()} ticks within the day, but found <null>.");
            }
        }
        ...
        public class NotHaveTicksWithinDay
        {
            ...
            public void When_a_offset_date_time_has_the_specified_ticks_within_the_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(offsetDateTime)} to have {offsetDateTime.TickOfDay.AsFormatted()} ticks within the day.");
            }
            ...
            public void When_asserting_a_null_offset_date_time_does_not_have_the_specified_ticks_within_the_day_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(offsetDateTime)} to have {tickOfDay.AsFormatted()} ticks within the day, but found <null>.");
            }
        }
        ...
        public class HaveTicksWithinSecond
        {
            ...
            public void When_a_offset_date_time_does_not_have_the_specified_tick_of_second_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(offsetDateTime)} to have {tickOfSecond} ticks within the second, but found {offsetDateTime.TickOfSecond}.");
            }
            ...
            public void When_asserting_a_null_offset_date_time_has_the_specified_tick_of_second_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(offsetDateTime)} to have {tickOfSecond} ticks within the second, but found <null>.");
            }
        }
        ...
        public class NotHaveTicksWithinSecond
        {
            ...
            public void When_a_offset_date_time_has_the_specified_tick_of_second_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(offsetDateTime)} to have {offsetDateTime.TickOfSecond} ticks within the second.");
            }
            ...
            public void When_asserting_a_null_offset_date_time_does_not_have_the_specified_tick_of_second_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(offsetDateTime)} to have {tickOfSecond} ticks within the second, but found <null>.");
            }
        }
        ...
        public class HaveYearWithinEra
        {
            ...
            public void When_a_offset_date_time_does_not_have_the_specified_as_the_year_within_the_era_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(offsetDateTime)} to have {yearOfEra} as the year within the era, but found {offsetDateTime.YearOfEra}.");
            }
            ...
            public void When_asserting_a_null_offset_date_time_has_the_specified_as_the_year_within_the_era_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Expected {nameof(offsetDateTime)} to have {yearOfEra} as the year within the era, but found <null>.");
            }
        }
        ...
        public class NotHaveYearWithinEra
        {
            ...
            public void When_a_offset_date_time_has_the_specified_as_the_year_within_the_era_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(offsetDateTime)} to have {offsetDateTime.YearOfEra} as the year within the era.");
            }
            ...
            public void When_asserting_a_null_offset_date_time_does_not_have_the_specified_as_the_year_within_the_era_it_fails()
            {
                ...
                act.Should().Throw<XunitException>()
                    .WithMessage(
                        $"Did not expect {nameof(offsetDateTime)} to have {yearOfEra} as the year within the era, but found <null>.");
            }
        }
    }
}
