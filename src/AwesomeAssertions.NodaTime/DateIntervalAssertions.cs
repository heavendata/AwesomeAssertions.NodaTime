...
namespace AwesomeAssertions.NodaTime
{
    ...
    public sealed class DateIntervalAssertions : ReferenceTypeAssertions<DateInterval?, DateIntervalAssertions>
    {
        ...
        public DateIntervalAssertions(DateInterval? subject, AssertionChain chain)
            : base(subject, chain)
        {
        }
        ...
        public AndConstraint<DateIntervalAssertions> Be(DateInterval? other, string because = "", params object[] becauseArgs)
        {
            CurrentAssertionChain
                ...
                .ForCondition(Equals(Subject, other))
        ...
        public AndConstraint<DateIntervalAssertions> BeInDays(int days, string because = "", params object[] becauseArgs)
        {
            CurrentAssertionChain
                .BecauseOf(because, becauseArgs)
                .WithExpectation("Expected {context:DateInterval} to be {0} days{reason}", days, chain =>
                {
                    if (Subject != null)
                        chain
                            .ForCondition(Subject.Length == days)
        ...
        public AndConstraint<DateIntervalAssertions> NotBeInDays(int days, string because = "", params object[] becauseArgs)
        {
            CurrentAssertionChain
                .BecauseOf(because, becauseArgs)
                .WithExpectation("Did not expect {context:DateInterval} to be {0} days{reason}", days, chain =>
                {
                    if (Subject != null)
                        chain
                            .ForCondition(Subject.Length != days)
        ...
        public AndConstraint<DateIntervalAssertions> EndAt(LocalDate? localDate, string because = "", params object[] becauseArgs)
        {
            CurrentAssertionChain
                .BecauseOf(because, becauseArgs)
                .WithExpectation("Expected {context:DateInterval} to end at {0}{reason}", localDate, chain =>
                {
                    if (Subject == null)
                        chain
                            .ForCondition(false)
            ...
            params object[] becauseArgs)
        {
            CurrentAssertionChain
                .BecauseOf(because, becauseArgs)
                .WithExpectation("Did not expect {context:DateInterval} to end at {0}{reason}", localDate, chain =>
                {
                    if (Subject != null)
                        chain
                            .ForCondition(!Subject.End.Equals(localDate))
            ...
            params object[] becauseArgs)
        {
            CurrentAssertionChain
                .BecauseOf(because, becauseArgs)
                .WithExpectation("Expected {context:DateInterval} to start at {0}{reason}", localDate, chain =>
                {
                    if (Subject == null)
                        chain
                            .ForCondition(false)
            ...
            params object[] becauseArgs)
        {
            CurrentAssertionChain
                .BecauseOf(because, becauseArgs)
                .WithExpectation("Did not expect {context:DateInterval} to start at {0}{reason}", localDate, chain =>
                {
                    if (Subject != null)
                        chain
                            .ForCondition(!Subject.Start.Equals(localDate))
            ...
            params object[] becauseArgs)
        {
            CurrentAssertionChain
                .BecauseOf(because, becauseArgs)
                .WithExpectation("Expected {context:DateInterval} to contain {0}{reason}", localDate, chain =>
                {
                    if (Subject != null)
                        chain
            ...
            params object[] becauseArgs)
        {
            CurrentAssertionChain
                .BecauseOf(because, becauseArgs)
                .WithExpectation("Did not expect {context:DateInterval} to contain {0}{reason}", localDate, chain =>
                {
                    if (Subject == null)
                        chain
                            .ForCondition(false)
        ...
        /// </returns>
        [CustomAssertion]
        public AndConstraint<DateIntervalAssertions> Contain(DateInterval dateInterval, string because = "",
            params object[] becauseArgs)
        {
            CurrentAssertionChain
                .BecauseOf(because, becauseArgs)
                .WithExpectation("Expected {context:DateInterval} to contain {0}{reason}", dateInterval, chain =>
                {
                    if (Subject != null)
                        chain
        ...
        /// </returns>
        [CustomAssertion]
        public AndConstraint<DateIntervalAssertions> NotContain(DateInterval dateInterval, string because = "",
            params object[] becauseArgs)
        {
            CurrentAssertionChain
                .BecauseOf(because, becauseArgs)
                .WithExpectation("Did not expect {context:DateInterval} to contain {0}{reason}", dateInterval, chain =>
                {
                    if (Subject == null)
                        chain
                            .ForCondition(false)
        ...
        ///         AndWhichConstraint&lt;DateIntervalAssertions,
        ///         CalendarSystem&gt;
        ///     </see>
            ...
            string because = "", params object[] becauseArgs)
        {
            CurrentAssertionChain
                .BecauseOf(because, becauseArgs)
                .WithExpectation("Expected {context:DateInterval} to be in calendar {0}{reason}", calendar, chain =>
                {
                    if (Subject != null)
                        chain
            ...
            params object[] becauseArgs)
        {
            CurrentAssertionChain
                .BecauseOf(because, becauseArgs)
                .WithExpectation("Did not expect {context:DateInterval} to be in calendar {0}{reason}", calendar, chain =>
                {
                    if (Subject != null)
                        chain
                            .ForCondition(!Subject.Calendar.Equals(calendar))
